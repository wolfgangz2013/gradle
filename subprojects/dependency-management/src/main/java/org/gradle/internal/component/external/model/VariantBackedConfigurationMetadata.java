...
class VariantBackedConfigurationMetadata implements ConfigurationMetadata {
    ...
    private final Action<ComponentDependenciesMetadataDetails> action;

    VariantBackedConfigurationMetadata(ModuleComponentIdentifier componentId, ComponentVariant variant, Action<ComponentDependenciesMetadataDetails> action) {
    ...
    public List<? extends DependencyMetadata> getDependencies() {
        List<DependencyMetadata> copy = new ArrayList<DependencyMetadata>(dependencies);
        action.execute(new ComponentDependenciesMetadataDetailsAdapter(copy, DependencyMetadataNotationParser.parser(DirectInstantiator.INSTANCE)));
        return copy;
    }
}
